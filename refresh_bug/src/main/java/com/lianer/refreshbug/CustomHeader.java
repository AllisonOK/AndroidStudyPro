...
//    protected TextView mLastUpdateText;
    ...
    public CustomHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//        mTitleText.setText(R.string.srl_component_falsify);
...
//                mTitleText.setText(REFRESH_HEADER_LOADING);
    ...
    public CustomHeader setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }
    public CustomHeader setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }
    public CustomHeader setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }
    public CustomHeader setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }
    public CustomHeader setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }
    public CustomHeader setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
...
//            mLastUpdateText.setText(mFormat.format(mLastTime));
    ...
    public CustomHeader setSpinnerStyle(SpinnerStyle style) {
        this.mSpinnerStyle = style;
        return this;
    }

    public CustomHeader setPrimaryColor(@ColorInt int primaryColor) {
...
//        mLastUpdateText.setTextColor(accentColor&0x00ffffff|0xcc000000);
    ...
    public CustomHeader setPrimaryColorId(@ColorRes int colorId) {
        setPrimaryColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public CustomHeader setAccentColorId(@ColorRes int colorId) {
        setAccentColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public CustomHeader setFinishDuration(int delay) {
...
//        mLastUpdateText.setVisibility(enable ? VISIBLE : GONE);
    ...
    public CustomHeader setTextSizeTitle(float size) {
//        mTitleText.setTextSize(size);
    ...
    public CustomHeader setTextSizeTitle(int unit, float size) {
...
//        mLastUpdateText.setTextSize(size);
    ...
    public CustomHeader setTextSizeTime(int unit, float size) {
//        mLastUpdateText.setTextSize(unit, size);
    ...
    public CustomHeader setTextTimeMarginTopPx(int px) {
...
//        mLastUpdateText.setLayoutParams(lp);
    ...
    public CustomHeader setDrawableMarginRight(float dp) {
        return setDrawableMarginRightPx(DensityUtil.dp2px(dp));
    }

    public CustomHeader setDrawableMarginRightPx(int px) {
    ...
    public CustomHeader setDrawableSize(float dp) {
        return setDrawableSizePx(DensityUtil.dp2px(dp));
    }

    public CustomHeader setDrawableSizePx(int px) {
    ...
    public CustomHeader setDrawableArrowSize(float dp) {
        return setDrawableArrowSizePx(DensityUtil.dp2px(dp));
    }

    public CustomHeader setDrawableArrowSizePx(int px) {
        ViewGroup.LayoutParams lpArrow = mArrowView.getLayoutParams();
        lpArrow.width = px;
        lpArrow.height = px;
        mArrowView.setLayoutParams(lpArrow);
    ...
    public CustomHeader setDrawableProgressSize(float dp) {
        return setDrawableProgressSizePx(DensityUtil.dp2px(dp));
    }

    public CustomHeader setDrawableProgressSizePx(int px) {
        ViewGroup.LayoutParams lpProgress = mProgressView.getLayoutParams();
        lpProgress.width = px;
