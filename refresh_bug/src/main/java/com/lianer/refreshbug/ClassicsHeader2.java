...
public class ClassicsHeader2 extends LinearLayout implements RefreshHeader {
...
//    private TextView mHeaderText;//标题文本
    ...
    public ClassicsHeader2(Context context, AttributeSet attrs) {
...
//        addView(mHeaderText, LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
    ...
    public int onFinish(@NonNull RefreshLayout layout, boolean success) {
        ...
        if (success) {
//            mHeaderText.setText(R.string.refresh_finish);
        } else {
